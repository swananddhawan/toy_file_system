...
void help(void)
{
	...
	printf("\t18. touch FileName : Change file time-stamps\n\n");
...
{
	if(mountFlag == 0 && ( (strcmp(parameter,"create") == 0 ) || (strcmp(parameter,"write") == 0 ) || (strcmp(parameter,"read") == 0 ) || (strcmp(parameter,"close") == 0 ) || (strcmp(parameter,"ls") == 0 ) || (strcmp(parameter,"pwd") == 0 ) ||(strcmp(parameter,"open") == 0 ) || (strcmp(parameter,"cat") == 0 ) || (strcmp(parameter,"stat") == 0 ) || (strcmp(parameter,"mkdir") == 0 ) || (strcmp(parameter,"cd") == 0 ) || (strcmp(parameter,"touch") == 0 ) || (strcmp(parameter,"append") == 0 ) || (strcmp(parameter,"rm") == 0 ) || (strcmp(parameter,"copy") == 0 ) ) )
		return -1;
	return 0;
}
...
void initializeDILB()
{
	...
	DILB[0].last_modified = time(NULL);
	DILB[0].last_accessed = time(NULL);
	DILB[0].inode_modified = time(NULL);
}
